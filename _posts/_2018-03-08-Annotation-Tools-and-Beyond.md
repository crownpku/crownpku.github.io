...
In some lucky cases, such label datasets are automatically generated. For example, in recommendation systems, people naturally generate label data by clicking on an ad on the webpage, adding stuff in their shopping card on Amazon, or listening to songs on Spotify.
